...
descr += "\n";
descr += "Examples:\n";
descr += "$ sig2poly_burg -p3 X -o Y -o V \n";
descr += "$ sig2poly_burg -d1 -p5 X -o Y -o V \n";
descr += "$ cat X | sig2poly_burg -p7 -m > Y \n";
...
if (i1.T==1u)
{
    ...
    if (codee::sig2poly_burg_s(Y,V,X,i1.R,i1.C,i1.S,i1.H,i1.iscolmajor(),dim,P,m0)) { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
    if (wo1)
    {
