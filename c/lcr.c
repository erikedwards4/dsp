//This gets LCs as usual, and then sums over (rectangular) window of length L.
...
int lcr_s (float *Y, const float *X, const int iscolmajor, const int R, const int C, const int L, const int dim, const int c0, const float stp, const int going, const float level);
int lcr_d (double *Y, const double *X, const int iscolmajor, const int R, const int C, const int L, const int dim, const int c0, const double stp, const int going, const double level);
...
int lcr_s (float *Y, const float *X, const int iscolmajor, const int R, const int C, const int L, const int dim, const int c0, const float stp, const int going, const float level)
{
    ...
    //Checks
    if (R<1) { fprintf(stderr,"error in lcr_s: R (nrows X) must be positive\n"); return 1; }
    if (C<1) { fprintf(stderr,"error in lcr_s: C (ncols X) must be positive\n"); return 1; }
    if (L<1) { fprintf(stderr,"error in lcr_s: L (winlength) must be positive\n"); return 1; }

    //Initialize Z
    if (!(Z=(int *)malloc((size_t)(N)*sizeof(int)))) { fprintf(stderr,"error in lcr_s: problem with malloc. "); perror("malloc"); return 1; }
    ...
    {
        fprintf(stderr,"error in lcr_s: dim must be 0 or 1.\n"); return 1;
    }
...
int lcr_d (double *Y, const double *X, const int iscolmajor, const int R, const int C, const int L, const int dim, const int c0, const double stp, const int going, const double level)
{
    ...
    //Checks
    if (R<1) { fprintf(stderr,"error in lcr_d: R (nrows X) must be positive\n"); return 1; }
    if (C<1) { fprintf(stderr,"error in lcr_d: C (ncols X) must be positive\n"); return 1; }
    if (L<1) { fprintf(stderr,"error in lcr_d: L (winlength) must be positive\n"); return 1; }

    //Initialize Z
    if (!(Z=(int *)malloc((size_t)(N)*sizeof(int)))) { fprintf(stderr,"error in lcr_d: problem with malloc. "); perror("malloc"); return 1; }
    ...
    {
        fprintf(stderr,"error in lcr_d: dim must be 0 or 1.\n"); return 1;
    }
