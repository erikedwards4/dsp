...
int triangular_s (float *Y, const size_t L, const size_t norm)
{
    ...
    const float p = 1.0f/(float)(L-(L%2u)*(L/2u));

    for (size_t l=0u; l<L/2u; ++l, ++Y) { *Y = (float)(l*(2u-L%2u)+1u)*p; }
    if (L%2u) { *Y++ = 1.0f; }
...
int triangular_d (double *Y, const size_t L, const size_t norm)
{
    ...
    const double p = 1.0/(double)(L-(L%2u)*(L/2u));
    
    for (size_t l=0u; l<L/2u; ++l, ++Y) { *Y = (double)(l*(2u-L%2u)+1u)*p; }
    if (L%2u) { *Y++ = 1.0; }
    for (size_t l=0u; l<L/2u; ++l, ++Y) { *Y = *(Y-(2u*l+1u+L%2u)); }
...
int triangular_c (float *Y, const size_t L, const size_t norm)
{
    ...
    for (size_t l=0u; l<L/2u; ++l, ++Y) { *Y = (float)(l*(2u-L%2u)+1u)*p; *++Y = 0.0f; }
...
int triangular_z (double *Y, const size_t L, const size_t norm)
{
    ...
    for (size_t l=0u; l<L/2u; ++l, ++Y) { *Y = (double)(l*(2u-L%2u)+1u)*p; *++Y = 0.0; }
    if (L%2u) { *Y++ = 1.0; *Y++ = 0.0; }
