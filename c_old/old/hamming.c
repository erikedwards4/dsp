...
int hamming_s (float *X, const size_t L, const char normalize);
int hamming_d (double *X, const size_t L, const char normalize);
int hamming_c (float *X, const size_t L, const char normalize);
int hamming_z (double *X, const size_t L, const char normalize);
...
int hamming_s (float *X, const size_t L, const char normalize)
{
    ...
    while (l<L/2) { X[l] = 0.54f - 0.46f*cosf(p*l); l++; }
    if (L%2) { X[l] = 1.0f; l++; }
...
int hamming_d (double *X, const size_t L, const char normalize)
{
    ...
    while (l<L/2) { X[l] = 0.54 - 0.46*cos(p*l); l++; }
    if (L%2) { X[l] = 1.0; l++; }
    while (l<L) { X[l] = X[L-l-1]; l++; }
...
int hamming_c (float *X, const size_t L, const char normalize)
{
    ...
    while (l<L/2) { X[2*l] = 0.54f - 0.46f*cosf(p*l); l++; }
    if (L%2) { X[2*l] = 1.0f; l++; }
...
int hamming_z (double *X, const size_t L, const char normalize)
{
    ...
    while (l<L/2) { X[2*l] = 0.54 - 0.46*cos(p*l); l++; }
    if (L%2) { X[2*l] = 1.0; l++; }
    while (l<L) { X[2*l] = X[2*(L-l-1)]; l++; }
