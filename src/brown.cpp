...
int main(int argc, char *argv[])
{
    ...
    void *argtable[] = {a_std, a_zmn, a_nr, a_nc, a_ns, a_nh, a_otyp, a_ofmt, a_fo, a_help, a_end};
    ...
    else if (o1.T==2)
    {
        ...
        if (codee::brown_d(Y,(double)std,o1.N(),zmn))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(&Y[0]),o1.nbytes()); }
    ...
    else if (o1.T==102u)
    {
        ...
        if (codee::brown_z(Y,(double)std,o1.N(),zmn))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(&Y[0]),o1.nbytes()); }
