...
int main(int argc, char *argv[])
{
    ...
    descr += "For a PyTorch-like interface with pad and dilation, see xcorr1d.\n";
    descr += "\n";
    ...
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ xcorr1 X1 X2 -o Y \n";
    descr += "$ xcorr1 -s2 X1 X2 > Y \n";
    descr += "$ cat X2 | xcorr1 -s2 -e15 -i2 -l400 X1 > Y \n";
    ...
    void *argtable[] = {a_fi, a_d, a_es0, a_str, a_dil, a_ly, a_fo, a_help, a_end};
    ...
    if (i1.T==1u)
    {
        ...
        if (codee::xcorr1_s(Y,X1,X2,i1.R,i1.C,i1.S,i1.H,i1.iscolmajor(),i2.N(),es0,str,dil,Ly,dim))
    ...
    else if (i1.T==2u)
    {
        ...
        if (codee::xcorr1_d(Y,X1,X2,i1.R,i1.C,i1.S,i1.H,i1.iscolmajor(),i2.N(),es0,str,dil,Ly,dim))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; } 
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
    ...
    else if (i1.T==101u)
    {
        ...
        if (codee::xcorr1_c(Y,X1,X2,i1.R,i1.C,i1.S,i1.H,i1.iscolmajor(),i2.N(),es0,str,dil,Ly,dim))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; } 
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
    ...
    else if (i1.T==102u)
    {
        ...
        if (codee::xcorr1_z(Y,X1,X2,i1.R,i1.C,i1.S,i1.H,i1.iscolmajor(),i2.N(),es0,str,dil,Ly,dim))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; } 
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
