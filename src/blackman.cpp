...
int main(int argc, char *argv[])
{
    ...
    descr += "\n";
    descr += "Include -e (--exact) to use the exact Blackman coeffs [default is truncated].\n";
    descr += "The truncated coeffs are more often used, but result in negative values at edges.\n";
    descr += "\n";
    ...
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ blackman -l255 -o Y \n";
    descr += "$ blackman -l255 > Y \n";
    descr += "$ blackman -l127 -d1 -t1 -f101 > Y \n";
    ...
    void *argtable[] = {a_wl, a_ex, a_nrm, a_d, a_otyp, a_ofmt, a_fo, a_help, a_end};
